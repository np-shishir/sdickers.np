...
export default function TrendingCollections({bgImage, title}) {
  return (
                        <div className='w-60 h-80 bg-contain rounded-2xl flex flex-col justify-end items-start relative cursor-pointer hover:scale-y-110 duration-500 ease-in-out' style={{backgroundImage: `url(${bgImage})`}}>
